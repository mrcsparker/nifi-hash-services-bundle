...
public class HashUtils {
    ...
    public static final AllowableValue HASH_ADLER32 = new AllowableValue("hash-adler32",
            "adler32",
            "A hash function implementing the Adler-32 checksum algorithm (32 hash bits).");

    public static final AllowableValue HASH_CRC32 = new AllowableValue("hash-crc32",
            "crc32",
            "A hash function implementing the CRC-32 checksum algorithm (32 hash bits).");

    public static final AllowableValue HASH_CRC32C = new AllowableValue("hash-crc32c",
            "crc32c",
            "A hash function implementing the CRC32C checksum algorithm (32 hash bits) as described by RFC 3720, Section 12.1.");

    public static final AllowableValue HASH_FARMHASHFINGERPRINT64 = new AllowableValue("hash-farmHashFingerprint64",
            "FarmHash's Fingerprint64",
            "A hash function implementing FarmHash's Fingerprint64, an open-source algorithm.");

    public static final AllowableValue HASH_SHA256 = new AllowableValue("hash-sha256",
        "sha256",
        "A hash function implementing the SHA-256 algorithm (256 hash bits).");

    public static final AllowableValue HASH_SHA384 = new AllowableValue("hash-sha384",
            "sha384",
            "A hash function implementing the SHA-384 algorithm (384 hash bits).");

    public static final AllowableValue HASH_SHA512 = new AllowableValue("hash-sha512",
            "sha512",
