...
/**
 * Here just in case we want to build an attribute lookup in the future.
 */
abstract class AbstractHashLookupService<T> extends AbstractControllerService implements LookupService<T> {
